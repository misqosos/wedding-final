    ...
    class DbConnection {
        ...
        public static function getDatabaseConnection() {
            ...
            if (!isset(self::$instance)) {
                ...
                self::$instance = new PDO('mysql:host=sql11.hostcreators.sk:3316;dbname=d29120_wedding', 'u29120_michal', 'Bazantnica1438@', array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
